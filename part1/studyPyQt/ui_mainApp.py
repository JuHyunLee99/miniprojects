...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lblMessage.setGeometry(QtCore.QRect(30, 20, 250, 21))
        self.lblMessage.setObjectName("lblMessage")
        self.btnOK = QtWidgets.QPushButton(Form)
        self.btnOK.setGeometry(QtCore.QRect(180, 120, 80, 30))
        self.btnOK.setObjectName("btnOK")
        self.btnPOP = QtWidgets.QPushButton(Form)
        self.btnPOP.setGeometry(QtCore.QRect(100, 120, 80, 30))
